...
- (void)configToolView {
    ...
    self.toolView.backgroundColor = MSBlueColor;
    ...
    saveBtn.titleLabel.font = FONTSIZE(16);
...
- (void)saveBtnClick {
    ...
    self.selectStr = [NSString stringWithFormat:@"%ld-%@-%@ %@:%@:59", [self.year integerValue], month, day, hour, minute];
